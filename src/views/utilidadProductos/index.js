...
export default function UtilidadProductos() {
  ...
  const columnas = [
    ...
    { id: 'precio', label: 'Precio', align: 'right', currency: true },
    { id: 'precio2', label: 'Precio2', align: 'right', currency: true },
    { id: 'precio3', label: 'Precio3', align: 'right', currency: true },
    { id: 'stock', label: '#Stock', align: 'right', numeric: true },
    { id: 'costo_unitario', label: 'Costo Unitario', align: 'right', decimal: true },
